...
const signupUser = async (root, args, context, info) => {
...
const signinUser = async (root, args, context, info) => {
...
const createRole = async (root, args, context, info) =>
  await context.db.mutation.createRole(
    {
      data: args
    },
    info
